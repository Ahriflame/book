...
namespace DataModels
{
	...
	/// Server Version : 12.3
	/// </summary>
	public partial class KnigozavrDB : LinqToDB.Data.DataConnection
	{
		...
		public ITable<PublishingHouse> PublishingHouses { get { return this.GetTable<PublishingHouse>(); } }
		public ITable<Rating>          Ratings          { get { return this.GetTable<Rating>(); } }
		...
		public KnigozavrDB(string configuration)
			: base(configuration)
		{
			InitDataContext();
			InitMappingSchema();
	...
	{
		[Column("ID_address"), PrimaryKey, NotNull] public int    IdAddress { get; set; } // integer
		[Column("city"),                   NotNull] public string City      { get; set; } // text
		[Column("street"),                 NotNull] public string Street    { get; set; } // text
		[Column("house"),                  NotNull] public string House     { get; set; } // text
		[Column("flat"),                   NotNull] public string Flat      { get; set; } // text
		[Column("client_ID"),              NotNull] public int    ClientId  { get; set; } // integer

		#region Associations

		/// <summary>
		/// address_ID_BackReference
		/// </summary>
		[Association(ThisKey="IdAddress", OtherKey="AddressId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Client> Ids { get; set; }
	...
	public partial class Book
	{
		...
		[Column("author"),                           NotNull] public string  Author            { get; set; } // text
		[Column("price"),                            NotNull] public decimal Price             { get; set; } // numeric
		[Column("year_of_publishing"),               NotNull] public int     YearOfPublishing  { get; set; } // integer
		[Column("pages"),                            NotNull] public int     Pages             { get; set; } // integer
		[Column("cover_type"),                       NotNull] public string  CoverType         { get; set; } // text
		[Column("age_limit"),                        NotNull] public int     AgeLimit          { get; set; } // integer
		[Column("annotation"),                       NotNull] public string  Annotation        { get; set; } // text
		[Column("part"),                   Nullable         ] public string  Part              { get; set; } // text
		[Column("series"),                 Nullable         ] public string  Series            { get; set; } // text
		[Column("ID_book"),             PrimaryKey,  NotNull] public int     IdBook            { get; set; } // integer
		[Column("publishing_house_ID"),              NotNull] public int     PublishingHouseId { get; set; } // integer
		[Column("rating_ID"),                        NotNull] public int     RatingId          { get; set; } // integer

		#region Associations

		/// <summary>
		/// book_ID_BackReference
		/// </summary>
		[Association(ThisKey="IdBook", OtherKey="BookId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Order> Ids { get; set; }

		/// <summary>
		/// publishing_house_ID
		/// </summary>
		[Association(ThisKey="PublishingHouseId", OtherKey="IdPublishingHouse", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="publishing_house_ID", BackReferenceName="PublishinghouseIds")]
		public PublishingHouse PublishingHouse { get; set; }

		/// <summary>
		/// rating_ID
		/// </summary>
		[Association(ThisKey="RatingId", OtherKey="IdRating", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="rating_ID", BackReferenceName="Ids")]
	...
	{
		[Column("ID_client"),  PrimaryKey,  NotNull] public int    IdClient  { get; set; } // integer
		[Column("name"),                    NotNull] public string Name      { get; set; } // text
		...
		[Column("password"),                NotNull] public string Password  { get; set; } // text
		...
		/// address_ID
		/// </summary>
		[Association(ThisKey="AddressId", OtherKey="IdAddress", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="address_ID", BackReferenceName="Ids")]
		public Address Address { get; set; }

		/// <summary>
		/// client_ID_BackReference
		/// </summary>
		[Association(ThisKey="IdClient", OtherKey="ClientId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Order> Ids { get; set; }
	...
	{
		[Column("ID_order"),  PrimaryKey, NotNull] public int IdOrder  { get; set; } // integer
		[Column("client_ID"),             NotNull] public int ClientId { get; set; } // integer
		[Column("book_ID"),               NotNull] public int BookId   { get; set; } // integer
		...
		/// book_ID
		/// </summary>
		[Association(ThisKey="BookId", OtherKey="IdBook", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="book_ID", BackReferenceName="Ids")]
		public Book Book { get; set; }

		/// <summary>
		/// client_ID
		/// </summary>
		[Association(ThisKey="ClientId", OtherKey="IdClient", CanBeNull=false, Relationship=Relationship.ManyToOne, KeyName="client_ID", BackReferenceName="Ids")]
		public Client Client { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="publishing_house")]
	public partial class PublishingHouse
	{
		[Column("ID_publishing_house"), PrimaryKey, NotNull] public int    IdPublishingHouse { get; set; } // integer
		[Column("name"),                            NotNull] public string Name              { get; set; } // text

		#region Associations

		/// <summary>
		/// publishing_house_ID_BackReference
		/// </summary>
		[Association(ThisKey="IdPublishingHouse", OtherKey="PublishingHouseId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Book> PublishinghouseIds { get; set; }
	...
	{
		[Column("ID_rating"),       PrimaryKey, NotNull] public int     IdRating      { get; set; } // integer
		[Column("book_ID"),                     NotNull] public int     BookId        { get; set; } // integer
		[Column("count_of_rating"),             NotNull] public int     CountOfRating { get; set; } // integer
		[Column("sum_of_rating"),               NotNull] public int     SumOfRating   { get; set; } // integer
		[Column("rating"),                      NotNull] public decimal RatingColumn  { get; set; } // numeric

		#region Associations

		/// <summary>
		/// rating_ID_BackReference
		/// </summary>
		[Association(ThisKey="IdRating", OtherKey="RatingId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Book> Ids { get; set; }
	...
	{
		public static Address Find(this ITable<Address> table, int IdAddress)
		{
			return table.FirstOrDefault(t =>
				t.IdAddress == IdAddress);
		}

		public static Book Find(this ITable<Book> table, int IdBook)
		{
			return table.FirstOrDefault(t =>
				t.IdBook == IdBook);
		}

		public static Client Find(this ITable<Client> table, int IdClient)
		{
			return table.FirstOrDefault(t =>
				t.IdClient == IdClient);
		}

		public static Order Find(this ITable<Order> table, int IdOrder)
		{
			return table.FirstOrDefault(t =>
				t.IdOrder == IdOrder);
		}

		public static PublishingHouse Find(this ITable<PublishingHouse> table, int IdPublishingHouse)
		{
			return table.FirstOrDefault(t =>
				t.IdPublishingHouse == IdPublishingHouse);
		}

		public static Rating Find(this ITable<Rating> table, int IdRating)
		{
			return table.FirstOrDefault(t =>
				t.IdRating == IdRating);
		}
